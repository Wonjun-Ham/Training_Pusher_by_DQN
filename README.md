...
과제 제출시 제출한 ‘3-1 강화학습 프로젝트’ 압축 폴더를 푸시고, ‘3-1 강화학습 프로젝트’ 폴더 그대로(colab에서 코드상 에러가 나지 않으려면 내부 디렉토리를 건들면 안 됩니다) 구글 드라이브의 ‘내 드라이브’에 업로드하시면 됩니다. 코드도 폴더에 포함돼있습니다. q-learning.ipynb와 DQN.ipynb입니다.
